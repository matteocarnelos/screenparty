...
public class PartyUtils {
    ...
    public static void computeFrameDimensions(PartyParams hostParam, List<? extends PartyParams> clientParams) {
        ...
        heights.add(hostParam.getScreenHeight());
        for(PartyParams clientParam : clientParams) heights.add(clientParam.getScreenHeight());
        ...
        hostParam.getMediaParams().setFrameWidth(hostParam.getScreenWidth());
